/*******************************************************************************
    ...
    than TBD uS for a 32 pixel wide display and less than TBD uS for a
    64 pixel wide display.

    TODO: Maximum refresh rate = 1 / (30 uS x 16 rows) = 2 KHz
    e.g. 100 Hz refresh = 1 / (100 * 16) = 625 uS refresh interval
